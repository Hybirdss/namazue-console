...
const LIMITS: Record<string, { max: number; window: number }> = {
  analyze:    { max: 20,   window: 3600 },
  search_ai:  { max: 60,   window: 3600 },
  search_sql: { max: 300,  window: 3600 },
  events:     { max: 3000, window: 3600 },
  reports:    { max: 3000, window: 3600 },
  ask:        { max: 40,   window: 3600 },
  chat:       { max: 60,   window: 3600 },
};
