...
const en: Record<string, string> = {
  ...
  'tsunami.risk.none': 'Tsunami risk is currently low, but keep watching official updates',
  ...
  'ai.disclaimer': 'Beta analysis. Errors, omissions, or delays may exist. Verify official releases and primary sources before making important decisions.',
  'disclaimer.beta.short': 'Beta information. Errors, omissions, or delays may exist. Verify official releases and primary sources before making important decisions.',
  ...
  'snapshot.scenarioWarning': 'Verify official releases before making response decisions',
  ...
  'impact.approx': '~',
  'impact.dataSource': 'MIC Resident Registry (2025-01-01) · {n} administrative units',

  // Command Palette
  'palette.searchPlaceholder': 'Search locations, bundles, layers, events…',
  'palette.noResults': 'No results',
  'palette.hintDefault': 'Type to search locations, bundles, views, layers, events…',
  ...
  'locationSafety.summary.safe': 'No immediate elevated shaking signal at this place.',
  'locationSafety.summary.selectedCaution': 'The current selected event may be felt here. Monitor updates.',
  'locationSafety.summary.nearbyCaution': 'Recent nearby activity warrants a closer look.',
  'locationSafety.summary.selectedDanger': 'Active shaking posture at this place warrants attention now.',
  'locationSafety.summary.nearbyDanger': 'Recent nearby shaking warrants attention now.',
  ...
  'shell.scenarioBannerSub': 'Verify official releases before making response decisions',
  ...
  'settings.on': 'ON',
  'settings.off': 'OFF',
  'settings.methodology.desc': 'Namazue Engine is built on the following academic models and public references.',
  'settings.methodology.betaNotice': 'Namazue is still in beta. Displayed information may contain errors, omissions, interpretation gaps, or update delays. Do not rely on this console alone for critical decisions; verify official releases and primary sources first.',
  ...
  'shortcuts.cycleTimeline': 'Cycle timeline range',
  ...
  'exposure.reason.lifelineCascade': 'lifeline cascade — upstream utility disruption elevates risk',
  ...
  // Priority rationale
  'priority.rationale': '{region} {classLabel} posture is {severity} because {reasons}.',
  ...
  'boot.failure.mapDetail': 'WebGL could not be initialized for the console. Check browser graphics settings or strict blocking policies, then refresh or try another browser.',
  'boot.failure.genericTitle': 'Unable to start Namazue',
  'boot.failure.genericDetail': 'Startup failed before the console became interactive. Refresh the page and try again.',
  ...
  'methodology.ref.siMidorikawa': 'Si & Midorikawa (1999) — Ground-motion attenuation model',
  'methodology.ref.wells': 'Wells & Coppersmith (1994) — Rupture-length and magnitude scaling',
  'methodology.ref.nakamura': 'Nakamura (1988) — UrEDAS early detection concept',
  'methodology.ref.jma': 'JMA — Earthquake and tsunami bulletins',
  'methodology.ref.mic': 'Statistics Bureau (MIC) — Population estimates and census data',
  ...
  'bundle.metric.noLifelineElevated': 'No lifeline corridors in elevated posture',
  ...
  'bundle.metric.urbanAligned': '{region} urban context aligned to current event',
  'bundle.metric.urbanStandby': 'Urban structural context on standby',
  'bundle.detail.requiresVerification': '{assets} requires operator verification.',
  'bundle.detail.pressureCentered': 'Primary operational pressure centered on {region}.',
  'bundle.detail.seismicStandby': 'National seismic truth is standing by for the next significant event.',
  'bundle.detail.coastalVerification': '{assets} require coastal verification.',
  'bundle.detail.highPriorityFeed': '{hp} high-priority vessels and {uw} underway in current feed.',
  'bundle.detail.underwayTraffic': '{n} underway across current coastal traffic.',
  'bundle.detail.aisStandby': 'AIS telemetry and coastal shipping posture are standing by.',
  'bundle.detail.corridorVerification': '{assets} require corridor verification.',
  'bundle.detail.lifelineStandby': 'Rail, power, water, and telecom views are standing by for corridor stress.',
  'bundle.detail.hospitalVerification': '{assets} require hospital access verification.',
  'bundle.detail.medicalStandby': 'Medical access and hospital readiness are standing by.',
  'bundle.detail.urbanVerification': '{assets} require urban integrity review.',
  'bundle.detail.builtEnvIntensify': 'Built-environment overlays will intensify at city-tier as structural layers come online.',
  'bundle.detail.builtEnvStandby': 'City-tier built-environment overlays will activate once an operator focus event is selected.',
  ...
  'ops.revisionsReview': '{n} revisions from {sources} require operator review.',
  'ops.revisionsShow': '{n} revisions from {sources} show {detail}.',
  'ops.noSignificantEvent': 'No operationally significant event selected',
  'ops.focusAutoSelected': 'Operational focus auto-selected from current incident stream',
  'ops.focusRetained': 'Operational focus retained on the current incident',
  'ops.focusEscalated': 'Operational focus escalated to a materially stronger incident',
  ...
  'rail.telemetry.staleWith': 'Rail telemetry is stale; using last confirmed corridor state.',
  'rail.telemetry.staleWithout': 'Rail telemetry is stale and no current corridor status is available.',
  'rail.telemetry.degradedWith': 'Rail telemetry is degraded; verify the last confirmed corridor state before acting.',
  'rail.telemetry.degradedWithout': 'Rail telemetry is degraded and no current corridor status is available.',
  'rail.telemetry.downWith': 'Rail telemetry is down; manual corridor verification is required.',
  'rail.telemetry.downWithout': 'Rail telemetry is down and no current corridor status is available.',
  'rail.telemetry.unknownWith': 'Rail telemetry state is unknown; verify the last confirmed corridor state before acting.',
  'rail.telemetry.unknownWithout': 'Rail telemetry state is unknown and no current corridor status is available.',
  'rail.label': 'Rail',
  ...
  'rail.detail.suspendedCause': '{line} is suspended on the live rail feed due to {cause}.',
  'rail.detail.partial': '{line} is operating in partial service.',
  'rail.detail.partialCause': '{line} is operating in partial service due to {cause}.',
  'rail.detail.delayed': '{line} is reporting delays.',
  'rail.detail.delayedCause': '{line} is reporting delays due to {cause}.',
  'rail.detail.pendingUpdate': '{line} is awaiting a confirmed live status update.',
  'rail.detail.nominal': 'Live rail telemetry shows nominal posture across monitored Shinkansen corridors.',
  ...
  'power.detail.nearScram': '{plant} is estimated near SCRAM thresholds at ~{pga} gal.',
  'power.detail.gridVerify': '{plant} is estimated at JMA {intensity} and requires grid verification.',
  'power.detail.continuity': '{plant} sits inside the current shake field and requires continuity verification.',
  ...
  'water.detail.outageRisk': '{site} is estimated at JMA {intensity} with potable-water continuity at risk.',
  'water.detail.continuityReview': '{site} is estimated at JMA {intensity} and requires distribution verification.',
  'water.detail.verification': '{site} is inside the current shake field and requires water continuity confirmation.',
  ...
  'poller.fallback.governor': 'Governor cadence is running without unified snapshot truth',
  'poller.fallback.maritime': 'Unified snapshot unavailable; serving last-known-good maritime cache if present',
  'poller.fallback.rail': 'Unified snapshot unavailable; serving last-known-good rail cache if present',
  'poller.fallback.transport': 'Unified snapshot unavailable; running on fallback transport',
  'poller.fallback.unavailable': 'Realtime snapshot and fallback feeds are unavailable',
  ...
  'health.degraded.detail': 'Fallback realtime feed active. Verify source confidence before acting.',
  'health.divergence.headline': 'Material revision divergence detected',
  'health.divergence.detail': 'Source revisions diverge materially and require operator review.',
  ...
  'health.conflict.detail': '{n} revisions from {sources} require operator review.',
  'health.lowConf.detail': 'Selected truth originates from a low-confidence {source} revision. Verify before acting.',
  'health.stale.detail': 'Primary feed is stale; decisions may lag current field conditions.',
  'health.nominal.headline': 'Primary realtime feed healthy',
  'health.nominal.detail': 'No source conflicts or realtime degradation detected.',
  ...
  'bundle.desc.maritime': 'Ships, port approaches, and coastal operational posture.',
  'bundle.desc.lifelines': 'Rail, airports, urban transfer nodes, power, water, and telecom corridors.',
  ...
  'response.uredas.desc': 'Earthquake Early Warning triggers automatic Shinkansen braking within seconds',
  'response.jma': 'JMA preliminary seismic intensity',
  'response.jma.desc': 'Japan Meteorological Agency issues initial seismic intensity report',
  'response.nhk': 'NHK earthquake bulletin',
  'response.nhk.desc': 'National broadcaster interrupts programming with earthquake details',
  'response.tsunami': 'Tsunami advisory/warning',
  'response.tsunami.desc': 'JMA issues tsunami advisory or warning based on epicenter and magnitude',
  'response.dmat': 'DMAT standby activation',
  'response.dmat.desc': 'Disaster Medical Assistance Teams placed on standby across affected regions',
  'response.fdma': 'FDMA disaster response HQ',
  'response.fdma.desc': 'Fire and Disaster Management Agency establishes disaster response headquarters',
  'response.sdf': 'SDF dispatch decision',
  'response.sdf.desc': 'Self-Defense Forces dispatch decision for disaster relief operations',
  'response.transport': 'Wide-area medical transport',
  'response.transport.desc': 'Activation of wide-area medical transport for critically injured patients',
  'response.cabinet': 'Cabinet emergency meeting',
  'response.cabinet.desc': 'Cabinet convenes emergency meeting for disaster countermeasures',
  'response.intl': 'International assistance request',
  'response.intl.desc': 'Government evaluates and potentially requests international disaster assistance',
  ...
  'domain.hospital.emergencyPower': 'Verify emergency power — generator start confirmed',
  ...
  'domain.nuclear.beyondDesignBasis': 'Beyond design basis — activate emergency protocol',
  ...
  'domain.power.backupActivation': 'Verify backup power activation at dependent facilities',
  ...
  'domain.port.cargoDiversion': 'Coordinate cargo diversion to alternative port',
  ...
  'domain.telecom.trafficMonitor': 'Monitor traffic congestion on remaining links',
  ...
  'domain.building.entryRestrict': 'Restrict building entry — damage assessment pending',
