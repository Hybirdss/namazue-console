...
const ja: Record<string, string> = {
  ...
  'ai.close': 'AIパネルを閉じる',
  'ai.disclaimer': 'ベータ分析です。誤り・欠落・遅延が含まれる場合があるため、重要な判断の前に公式発表と一次ソースを再確認してください。',
  'disclaimer.beta.short': 'ベータ情報です。誤り・欠落・遅延が含まれる場合があるため、重要な判断の前に公式発表と一次ソースを再確認してください。',
  ...
  'snapshot.scenarioDisclaimer': 'ベータシミュレーション · 実際の地震ではありません',
  ...
  'locationSafety.summary.safe': 'この地点で直ちに高い揺れシグナルはありません。',
  'locationSafety.summary.selectedCaution': '現在選択中の地震の影響が想定されます。更新を監視してください。',
  'locationSafety.summary.nearbyCaution': '周辺の直近活動が増えており、注意が必要です。',
  'locationSafety.summary.selectedDanger': 'この地点は現在の選択地震による強い揺れに注意が必要です。',
  'locationSafety.summary.nearbyDanger': '周辺の直近の揺れが強く、注意が必要です。',
  ...
  // Shell (dynamic)
  'shell.scenarioBannerText': 'ベータシミュレーション — 実際の地震ではありません',
  ...
  'settings.on': 'ON',
  'settings.off': 'OFF',
  'settings.methodology.desc': 'Namazue Engineは以下の学術モデルと公共機関のレファレンスを基に設計されています。',
  'settings.methodology.betaNotice': 'Namazueはまだベータ段階です。表示情報には誤り、欠落、解釈差、更新遅延が含まれる場合があります。重要な判断ではこのコンソールだけに依存せず、まず公式発表と一次ソースを再確認してください。',
  ...
  'shortcuts.cycleTimeline': 'タイムライン範囲切替',
  ...
  'exposure.reason.lifelineCascade': 'ライフライン連鎖 — 上流インフラ障害によるリスク上昇',
  ...
  // Priority rationale
  'priority.rationale': '{region}の{classLabel}は{severity}態勢です。理由: {reasons}。',
  ...
  'boot.failure.mapDetail': 'コンソールに必要なWebGLを初期化できませんでした。ブラウザの描画設定や強いブロック設定を確認し、再読み込みするか別のブラウザを試してください。',
  'boot.failure.genericTitle': 'Namazueを開始できません',
  'boot.failure.genericDetail': 'コンソールが操作可能になる前に起動に失敗しました。ページを再読み込みしてもう一度お試しください。',
  ...
  'scenario.disclaimer.body': 'これはベータ版のシミュレーション機能です。\n表示されるデータは実際の地震情報ではなく、誤り・欠落・遅延が含まれる場合があります。',
  'scenario.disclaimer.warning': '実際の災害対応や安全判断には使用しないでください。\n重要な判断の前に、必ず公的機関の発表と一次ソースを再確認してください。',
  ...
  'methodology.ref.wells': 'Wells & Coppersmith (1994) — 断層長-マグニチュードスケーリング',
  ...
  'bundle.detail.requiresVerification': '{assets}のオペレーター確認が必要です。',
  'bundle.detail.pressureCentered': '主要な運用負荷は{region}に集中しています。',
  'bundle.detail.seismicStandby': '次の重大イベントに備えて待機中です。',
  'bundle.detail.coastalVerification': '{assets}の沿岸確認が必要です。',
  'bundle.detail.highPriorityFeed': '優先船舶{hp}隻、航行中{uw}隻がフィード中。',
  ...
  'bundle.detail.lifelineStandby': '鉄道・電力・水道・通信の回廊ストレス監視は待機中です。',
  'bundle.detail.hospitalVerification': '{assets}の病院アクセス確認が必要です。',
  'bundle.detail.medicalStandby': '医療アクセスと病院即応体制は待機中です。',
  'bundle.detail.urbanVerification': '{assets}の都市構造健全性確認が必要です。',
  'bundle.detail.builtEnvIntensify': '構造レイヤーのオンラインに伴い、市区レベルで建築環境オーバーレイが強化されます。',
  'bundle.detail.builtEnvStandby': 'オペレーターフォーカスイベントが選択されると、市区レベルの建築環境オーバーレイが有効になります。',
  ...
  'ops.revisionsReview': '{sources}からの{n}回改訂にオペレーター確認が必要です。',
  ...
  'rail.telemetry.staleWith': '鉄道テレメトリが遅延しています。最終確認済みの回廊状態を使用しています。',
  'rail.telemetry.staleWithout': '鉄道テレメトリが遅延しており、現在の回廊状態は取得できていません。',
  'rail.telemetry.degradedWith': '鉄道テレメトリが劣化しています。行動前に最終確認済みの回廊状態を検証してください。',
  'rail.telemetry.degradedWithout': '鉄道テレメトリが劣化しており、現在の回廊状態は取得できていません。',
  'rail.telemetry.downWith': '鉄道テレメトリが停止しています。手動による回廊確認が必要です。',
  'rail.telemetry.downWithout': '鉄道テレメトリが停止しており、現在の回廊状態は取得できていません。',
  'rail.telemetry.unknownWith': '鉄道テレメトリの状態が不明です。行動前に最終確認済みの回廊状態を検証してください。',
  'rail.telemetry.unknownWithout': '鉄道テレメトリの状態が不明であり、現在の回廊状態は取得できていません。',
  'rail.label': '鉄道',
  ...
  'rail.detail.nominal': '鉄道テレメトリは監視中の新幹線回廊全体で正常態勢を示しています。',
  ...
  'power.detail.gridVerify': '{plant}は推定JMA {intensity}であり、送電網の確認が必要です。',
  'power.detail.continuity': '{plant}は現在の震動領域内にあり、運転継続の確認が必要です。',
  ...
  'water.detail.outageRisk': '{site}は推定JMA {intensity}であり、上水道の継続性にリスクがあります。',
  'water.detail.continuityReview': '{site}は推定JMA {intensity}であり、配水系統の確認が必要です。',
  'water.detail.verification': '{site}は現在の震動領域内にあり、水道継続性の確認が必要です。',
  ...
  'poller.fallback.governor': '統合スナップショットなしでガバナーケイデンスが稼働中',
  'poller.fallback.maritime': '統合スナップショット利用不可；海事キャッシュがあれば最終正常値を提供',
  'poller.fallback.rail': '統合スナップショット利用不可；鉄道キャッシュがあれば最終正常値を提供',
  'poller.fallback.transport': '統合スナップショット利用不可；フォールバック転送で稼働中',
  'poller.fallback.unavailable': 'リアルタイムスナップショットとフォールバックフィードが利用できません',
  ...
  'health.degraded.detail': 'フォールバックリアルタイムフィードが稼働中。行動前にソースの信頼性を確認してください。',
  'health.divergence.headline': 'リビジョン間の重大な乖離を検出',
  'health.divergence.detail': 'ソースリビジョンが大きく乖離しており、オペレーター確認が必要です。',
  'health.conflict.headline': 'ソース間のリビジョン競合を検出',
  'health.lowConf.headline': '選択イベントの情報信頼度が低い',
  'health.stale.headline': 'リアルタイム更新が遅延中',
  'health.conflict.detail': '{sources}からの{n}回改訂にオペレーター確認が必要です。',
  'health.lowConf.detail': '選択された情報は低信頼度の{source}リビジョンに基づいています。行動前に確認してください。',
  'health.stale.detail': 'プライマリフィードが遅延中です。判断が現地状況より遅れる可能性があります。',
  ...
  // Realtime Status
  'realtime.fallbackStale': 'フォールバックフィード稼働中、データが遅延しています',
  ...
  'response.tsunami.desc': '気象庁が震源とマグニチュードに基づき津波注意報または警報を発表',
